...
public:
	...
	char lastAction[26]; // 0x1FF4
	char pad_200E[6]; // 0x200E
	char current_action2[26];// 0x2014 another current action I guess, gets set by the set_action_override
	char pad_202E[18]; // 0x202E
	char set_action_override[26]; // 0x2048 this sets the current action overriding the script order I guess? not sure, still need more testing
	char pad_205A[22]; // 0x205A
	char currentAction[26]; // 0x2070
	char pad_208A[446]; // 0x208A
